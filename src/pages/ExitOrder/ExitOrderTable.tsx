      ...
      <div className="hidden md:block w-full overflow-x-auto">
        <table className="min-w-full divide-y divide-gray-100 dark:divide-white/[0.05]">
          <thead className="bg-gray-100 dark:bg-white/[0.02]">
            <tr>
              <SortableHeader label="Vehículo" sortKey="placa" currentKey={sortKey} dir={sortDir} onToggle={toggle} />
              <SortableHeader label="Cliente" sortKey="client_name" currentKey={sortKey} dir={sortDir} onToggle={toggle} />
              <SortableHeader label="Conductor" sortKey="driver_name" currentKey={sortKey} dir={sortDir} onToggle={toggle} />
              <SortableHeader label="Fecha salida" sortKey="exit_date" currentKey={sortKey} dir={sortDir} onToggle={toggle} />
              <SortableHeader label="Hora salida" sortKey="exit_time" currentKey={sortKey} dir={sortDir} onToggle={toggle} />
              <SortableHeader label="Fecha entrada" sortKey="entry_date" currentKey={sortKey} dir={sortDir} onToggle={toggle} />
              <SortableHeader label="Hora entrada" sortKey="entry_time" currentKey={sortKey} dir={sortDir} onToggle={toggle} />
              <SortableHeader label="Referencia" sortKey="exit_reason" currentKey={sortKey} dir={sortDir} onToggle={toggle} />
            </tr>
          </thead>
          <tbody>
            {sorted.map((o) => (

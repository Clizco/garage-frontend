...
export default function UpdateVehicle() {
  ...
  return (
    <ComponentCard title={<button onClick={() => navigate(-1)} className="flex items-center gap-2 hover:text-blue-500 transition-colors"><span>←</span> Actualizar Vehículo</button>}>

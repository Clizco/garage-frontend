...
const SignInForm: React.FC = () => {
  ...
  const handleLogin = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const decodedResponse = await axios.get<{ id: string }>(userApiUrl, {
        headers: {
      ...
      const userRoleUrl = `${apiUrl}/users/users/role/${userId}`;
      interface RoleResponse {
        role: string;
      }

      const roleResponse = await axios.get<RoleResponse>(userRoleUrl, {
        headers: {
          "x-access-token": token,
        },
      });
